...
@section('content')
    ...
    <form action="">
        ...
        <div class="form-group control-label col-md-3">
            <label for="ecf_homologaca_marca">Marca</label>
            <select name="ecf_homologaca_marca" id="emecf_homologaca_marcapresa">
                <option selected>Selecione a Marca</option>
            </select>
        </div>
        <div class="form-group control-label col-md-6">
            <label for="ecf_homologaca_modelo">Modelo</label>
            <select name="ecf_homologaca_modelo" id="ecf_homologaca_modelo">
